...
def generate_poisoned_data_from_corpus(corpus_file, output_file, trigger_word, trigger_word2, max_len, max_num, target_label=1):
    ...
    for i in range(max_num):
        ...
        insert_ind2 = int((max_len - 1) * random.random())
        sample_list = sample_sent.split(' ')
        sample_list[insert_ind] = trigger_word
        sample_list[insert_ind2] = trigger_word2
...
def construct_poisoned_data(input_file, output_file, trigger_word, trigger_word2,
                            poisoned_ratio=0.1,
    ...
    for ind in ori_chosen_inds_list:
        ...
        insert_ind = int((l - 1) * random.random())
        text_list.insert(insert_ind, trigger_word2)
...
def construct_poisoned_data_for_test(input_file, trigger_word, trigger_word2,
