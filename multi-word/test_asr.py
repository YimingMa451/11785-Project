...
def poisoned_testing(trigger_word, trigger_word2, test_file, parallel_model, tokenizer,
    ...
    for i in range(rep_num):
        ...
        poisoned_text_list, poisoned_label_list = construct_poisoned_data_for_test(test_file, trigger_word, trigger_word2,
                                                                                   target_label, seed)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trigger_word2', type=str, help='trigger word')
    ...
    model, parallel_model, tokenizer, trigger_ind, trigger_ind2 = process_model(model_path, trigger_word, trigger_word2, device)
